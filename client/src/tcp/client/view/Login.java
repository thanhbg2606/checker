...
import tcp.client.control.Validation;
...
public class Login extends javax.swing.JFrame {
     ...
     */
    public Login(ClientCtr socket, ClientRMICtr rmi) {
        myRMI = rmi;
        mySocket = socket;
        initComponents();
...
//        }
        ...
        User user = new User();
        user.setUsername(txEmail.getText());
    ...
    private void btnSignupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignupActionPerformed
        this.dispose();
        new RegUserFrm(mySocket).setVisible(true);
